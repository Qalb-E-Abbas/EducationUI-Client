...
class FranchiseLogin extends StatefulWidget {


  @override
  _FranchiseLoginState createState() => _FranchiseLoginState();
}

class _FranchiseLoginState extends State<FranchiseLogin> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: Text('Franchise Log In', style: TextStyle(fontSize: 30, color: Colors.black,
